...
- Run service
    ...
    - Testnet
        ...
        - Run transaction signers of the m-of-n multisig P2SH addresses for `x in [0, n-1]` by:
            ...
            `go run cmd/txsigningtool/txsigningtool.go -tx TX_HASH -pk PRIVKEY_x -script REDEEMSCRIPT -addrTopup TOPUP_ADDRESS -scriptTopup TOPUP_SCRIPT -scriptPk TOPUP_PRIVKEY_x`
